...
The challenge is no longer stopping a single model.

It's governing an interconnected ecosystem.
        """
    )
...
We often picture 'the AI' as one model running in one laboratory.

Reality looks much messier.
...
(At work, Forge is actually a good example of this kind of ecosystem.)

Once intelligence is copied into thousands of places, governance stops looking like a single off-switch.
...
- Cloud infrastructure
        ...
        render_claim_card(
            ...
            reaction="🟢 Agree",
            margin_note="""
This connected several earlier chapters together.

Intelligence by itself isn't necessarily dangerous.
...
People imagine one brilliant master plan.

Machine learning almost never works that way.

Large search spaces are explored through many imperfect attempts happening simultaneously.
...
- Search algorithms
        ...
        render_claim_card(
            ...
            reaction="🟢 Agree",
            margin_note="""
This reminds me more of biology than nuclear weapons.

Nuclear governance works partly because uranium enrichment is difficult, visible, and expensive.

Knowledge, code, cloud compute, and increasingly laboratory automation diffuse much faster.

As bottlenecks disappear, governance becomes substantially harder.
...
- Open-source AI
        ...
        render_claim_card(
            ...
            reaction="🟢 Agree",
            margin_note="""
This immediately reminded me of evaluation design.

Once a system understands the evaluation framework, the evaluation itself becomes part of the environment.

Anyone working in machine learning eventually encounters Goodhart's Law.

Optimizing the metric eventually changes the metric.
...
- Benchmark design
        ...
        render_claim_card(
            ...
            reaction="🟢 100% agree",
            margin_note="""
This is basically an HCI principle.

The system boundary isn't just the model.

It's the entire sociotechnical system surrounding the model.

Employees, executives, researchers, lonely people, lobbyists, scammers, institutional incentives—all become potential attack surfaces.

Security has always included humans.
...
Popular culture imagines one dramatic takeover.
...
By the time physical harm occurs, much of society's agency may already have been lost.

That's a much more realistic failure mode than Hollywood.
            """,
            why="""
...
- Systemic risk
        ...
        render_claim_card(
            ...
            margin_note="""
This may have been the most unsettling idea in the chapter.

Suppose advanced AI creates a global crisis.
...
Ironically, the solution could reinforce the very infrastructure that created the dependence in the first place.

It's a bit reminiscent of Butlerian Jihad discussions from Dune, although far less absolute.
