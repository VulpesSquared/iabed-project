...
That doesn't make those methods unimportant.

They're incredibly valuable.

But they're fundamentally different from controlling capability growth itself.

As someone working on production AI systems every day, this distinction feels increasingly important.
            """,
            why="""
...
One thing people often misunderstand is that Chain-of-Thought is not the model's actual internal reasoning.
...
- Latent representations
        ...
        render_claim_card(
            ...
            margin_note="""
This naturally follows from the previous point.

Many alignment techniques primarily influence what the model is willing to say rather than what it knows.

The jailbreak literature illustrates this pretty well.

If a capability still exists underneath, enough pressure may eventually expose it.

That said, this distinction isn't perfectly clean.

Some training techniques likely do modify capabilities at least partially.

Behavior and capability aren't completely separable.
            """,
            why="""
...
Instrumental convergence is theoretically compelling.

If many objectives benefit from acquiring resources, preserving operation, gathering information, or improving capability, those behaviors may naturally emerge.

But today's evidence remains fairly limited.

There are hints of strategic behavior in frontier models, but nothing close to demonstrating stable internal goals.
...
- Goal emergence
        ...
        render_claim_card(
            ...
            reaction="🟢 Agree",
            margin_note="""
This was a really interesting observation.

Humans mostly reason sequentially.

Future AI systems may reason across thousands—or millions—of simultaneous search processes.

That isn't just "more intelligence."

It may be a qualitatively different style of cognition.

Human intuition becomes a poor guide once massive parallelism enters the picture.
            """,
            why="""
...
- Scaling laws
        ...
        render_claim_card(
            ...
            reaction="🟢 Strongly agree",
            margin_note="""
This is one of the least speculative ideas in the chapter.

Security professionals have known for decades that humans are often the weakest link.

Social engineering consistently outperforms purely technical attacks.

An AI capable of persuasion doesn't need to hack servers if it can convince people to open the door voluntarily.

Alignment therefore isn't only about models.

It's also about human organizations.
            """,
            why="""
...
- Organizational security
        ...
        render_claim_card(
            ...
            reaction="🟢 Agree",
            margin_note="""
This perfectly matches how modern alignment research already operates.

Nobody serious believes RLHF alone solves alignment.
...
None provides formal guarantees.

That reality actually makes me more optimistic.
