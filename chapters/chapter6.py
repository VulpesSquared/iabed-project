...
A less capable civilization may not be able to imagine the strategic options available to a more capable one.

That does not mean the more capable system is magical.
...
The strongest version of this argument is not, "We cannot name the weapon, therefore anything is possible."

It is, "Our inability to specify the mechanism does not prove the mechanism does not exist."
            """,
            why="""
...
Biology is an obvious example.

So are cognition, cybersecurity, complex infrastructure, and social systems.
...
It is that enough of an intelligence gap becomes a strategic gap.

Humans are already easy to influence through recommendation systems, propaganda, targeted advertising, social engineering, and incentive design.
...
The point is not mind control.

The point is that prediction, persuasion, timing, and leverage can compound until meaningful human control becomes unrealistic.
